"""NLPtoSQLQuery URL Configuration
...
from NLPtoSQLQuery import views as mainView
...
urlpatterns = [
    ...
    path("GenerateSQL/", usr.GenerateSQL, name="GenerateSQL"),
    path("GenerateSQLProcess/", usr.GenerateSQLProcess, name="GenerateSQLProcess"),
    path("ExecuteSQLProcess/", usr.ExecuteSQLProcess, name="ExecuteSQLProcess"),
    path("UserDatasetViewPraw/", usr.UserDatasetViewPraw, name="UserDatasetViewPraw"),
    path("UserTableRowsResults/", usr.UserTableRowsResults, name="UserTableRowsResults"),
